{ config, pkgs, inputs, ...}:{ programs.firefox = { package = pkgs.firefox; enable=true; languagePacks = [ "jp" ];
policies = { DefaultDownloadDirectory = "\${home}/X/Downloads"; }; profiles.hatosu = { isDefault=true;
      ...
      bookmarks = [
        { name = ""; url = "https://search.nixos.org/packages?"; }
        { name = ""; url = "https://home-manager-options.extranix.com/?query=&release=master"; }
        { name = ""; url = "https://github.com/hatosu/personal"; }
      ];
